...
public class ModZombie
{
  ...
  String say = "mob.zombie.say";
  String hurt = "mob.zombie.hurt";
  String death = "mob.zombie.death";
  String step = "mob.zombie.step";

  public ModZombie(World world)
  {
    this(world, 0.25D, 10, 20, 16f, 1f);
  }

  @SuppressWarnings("rawtypes")
public ModZombie(World world, double speed, int damage, int health, Float aggro, float multi)
  {
    super(world);
    this.speed = speed;
